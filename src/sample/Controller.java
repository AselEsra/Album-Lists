...
public class Controller implements Initializable {
    ...
    public Connection getConnection(){
        Connection con;
        try{
            con= DriverManager.getConnection("jdbc:mysql://localHost:3306/lib","root","Database24!");
            return con;
        }catch (Exception e){
    ...
    private void insertRecord(){
        String query = "INSERT INTO songs VALUES(" + tfID.getText() + ",'"+ tfArtist.getText() + "','" + tfAlbum.getText() + "','" + tfGenre.getText() + "'," + tfYear.getText() + ")";
        executeQuery(query);
        showSongs();
        deleteFields();
    }
